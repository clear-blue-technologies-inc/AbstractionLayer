/***************************************************************************//**
* @author   Ben Haubrich
* @file     CbtNetworkAbstraction.hpp
* @details  \b Synopsis: \n Interface for communication over the network.
* @ingroup  FoundationCore
*******************************************************************************/
#ifndef __CBT_NETWORK_ABSTRACTION_HPP__
#define __CBT_NETWORK_ABSTRACTION_HPP__

//Foundation
#include "CbtCommunicationProtocol.hpp"
//C++
#include <string>
...
#endif // __CBT_NETWORK_ABSTRACTION_HPP__