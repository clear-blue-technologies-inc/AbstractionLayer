/**************************************************************************//**
* @author Ben Haubrich                                        
* @file   CbtChainOfResponsibility.hpp
...
*******************************************************************************/
#ifndef __CBT_CHAIN_OF_RESPONSIBILITY_HPP__
#define __CBT_CHAIN_OF_RESPONSIBILITY_HPP__
    ...
    */
    class ChainOfResponsibility : public Global<ChainOfResponsibility> {
        ...
        */
        ...
        std::string binaryQueueSemaphore = "binaryQueueSem";
