/***************************************************************************//**
* @author   Ben Haubrich
* @file     CbtUartAbstraction.hpp
* @details  Abstraction layer for UART communication.
* @ingroup  FoundationCore
*******************************************************************************/
#ifndef __CBT_UART_ABSTRACTION_HPP__
#define __CBT_UART_ABSTRACTION_HPP__

//Foundation
#include "CbtError.hpp"
#include "CbtTypes.hpp"
#include "CbtIcCommunicationProtocol.hpp"
//C
#include <stdint.h>
...
#endif // __CBT_UART_ABSTRACTION_HPP__
